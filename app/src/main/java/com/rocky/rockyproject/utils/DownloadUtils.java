...
//<receiver android:name="com.wuxiaolong.androidutils.library.DownloadUtils$DownloadManagerReceiver">
//<intent-filter>
...
//</receiver>
//步骤2：
//DownloadUtils downloadUtil=new DownloadUtils(activity,downloadUrl);
////下载显示名字，不能是中文
...
public class DownloadUtils {
    ...
    private void initDownload(String downloadUrl) {
        ...
        //设置notification的标题
        downloadRequest.setTitle("正在下载应用");
        //设置notification的描述
