package com.jungle.utility.utils.config;
...
public class ConstUtils {
     ...
     * 正则：密码2
     */
    public static final String REGEX_PASSWORD2 = "(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,}";

    /**
     * 正则：车牌号
     */
    public static final String REGEX_VEHICLENUMBER = "^[京津晋冀蒙辽吉黑沪苏浙皖闽赣鲁豫鄂湘粤桂琼川贵云藏陕甘青宁新渝]?[A-Z][A-HJ-NP-Z0-9学挂港澳练]{5}$";
}