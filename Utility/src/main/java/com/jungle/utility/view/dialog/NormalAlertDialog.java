...
public class NormalAlertDialog {
    ...
    public NormalAlertDialog(Builder builder) {
        ...
        mDialogView.setMinimumHeight((int) (ScreenUtils
                .getScreenHeight(mBuilder.getContext()) * builder.getHeight()));
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.base_btn_check_color);
            rightButtonText = "确定";
