...
//                }
    ...
    private Button getButton(String text, int position) {
        ...
        int paddingSize = DensityUtils.dp2px(mBuilder.getContext(), 10);
        button.setPadding(paddingSize, 0, paddingSize, 0);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            onItemListener = null;
            itemHeight = DensityUtils.dp2px(context, 45); // 默认item高度
            itemWidth = 0.75f;
