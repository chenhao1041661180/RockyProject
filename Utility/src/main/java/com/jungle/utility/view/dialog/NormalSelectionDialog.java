...
import com.jungle.utility.utils.DensityUtils;
...
public class NormalSelectionDialog {
    ...
    public NormalSelectionDialog(Builder builder) {
        ...
        lp.width = (int) (ScreenUtils.getScreenWidth(mBuilder.getContext()) *
    ...
    private void loadItem() {
        ...
        if (mBuilder.getTitleVisible()) {
            ...
            l.height = DensityUtils.dp2px(mBuilder.getContext(), mBuilder.getTitleHeight());
